...
The Pal~5 stream has features not reproduced in a static model of the Milky Way, but their origin is unclear.
As Pal~5 has a surviving progenitor, it is arguably our best chance for disentangling different mechanisms that shape the stream, but more robust map of the entire tidal debris is required.
