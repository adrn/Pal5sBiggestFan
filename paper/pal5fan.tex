...
% , we demonstrated that the perturbation by the Milky Way bar can produce many of the features observed in Pal~5, including the shorter length and larger width of the leading tail compared to the trailing tail.
% - global perturbers can separately produce asymmetry in the length or width of the leading and the trailing tail
% \ab{rephrase as needed once the rest of the analysis is in place}

% \ab{maybe use this elsewhere?}
...
This scenario predicts that the bar sweeps tidal debris from the leading arm to a much wider area, and predicts the presence of low-surface brightness debris beyond $\rm Dec\lesssim-5^\circ$.
Deep, wide-field DECaLS photometry enabled us to trace the leading tail as it fans out to $\rm Dec\sim-7^\circ$, and the color-magnitude diagram implies Pal~5 debris has been spread out to even lower surface-brightness level between $-7^\circ\gtrsim\rm Dec\gtrsim-10^\circ$, thus confirming Pal~5 has been perturbed by the bar.
...
% A combination of deeper imaging along the leading tail and a quantitative analysis of its width and density  will constrain the mass and pattern speed of the Galactic bar.
...
Ultimately, our discoveries bode well for future studies of stellar streams.
As valuable tracers for 3D mapping of matter in galaxies, streams have already provided constraints on the mass of the Large Magellanic Cloud \citep{Erkal:2019} and revealed the presence of a yet unidentified, low-mass object \citep{Bonaca:2018b}.
...
Initially, extragalactic streams will be detected almost exclusively photometrically, but our results suggest that will still enable precise three-dimensional mapping of their host galaxies, and thus provide a unique test of the $\Lambda$CDM cosmology.
