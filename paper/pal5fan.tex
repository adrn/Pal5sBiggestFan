...
- to select likely pal5 stars, we start with a tractor, forced photometry catalog \citep{lang}
- we query the catalog for point sources, satisfying these criteria:
