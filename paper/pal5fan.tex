...
In particular, we  compute the co-rotation radius, $r_{\rm CR},$ based on the mass profiles of the static potential for any given pattern speed, $\Omega_b$. We then scale the bar model for a given pattern speed, $\Omega_b$, by:
