...
\end{equation}
If the scaling in Equation \ref{eq:scale} is not included (as the case for bar models in e.g. %\citealt{price:2016b},
...
%The specific model presented in \citet{Pearson:2017} predicts the presence of low-surface brightness debris beyond $\rm Dec\lesssim-5^\circ$ (previous detection limit).
