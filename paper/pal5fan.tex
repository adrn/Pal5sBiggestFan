...
Accounting for the field Milky Way population, we find $3000\pm100$ Pal~5 stars between $20<g<23$.
...
On the other hand, the leading tail rapidly increases in width to $\sigma\approx0.4^\circ$ at $\phi_1\approx7^\circ$.
...
% and compare it to the observed Pal~5 results in Figure~\ref{fig:sims}.
