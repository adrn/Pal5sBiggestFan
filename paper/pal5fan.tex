...
{\bf 1) NFW potential}: consisting of a disk, bulge and halo. We use two different fattenings for the dark matter halo to illustrate Pal 5 on a regular as opposed to chaotic orbit.  

{\bf  2) Barred potential}: consisting af a disk, halo and bar with varying pattern speeds and bar masses.
We use the basis function expansion (\citealt{wang:2012}). 
We use $n=9$, $l=19$ (\citealt{banik:2019}). 

We explore a range of pattern speeds of the bar from $\Omega_b$ = (25 to 66) $\kms$ kpc$^{-1}$ in increments of 1 kpc$^{-1}$. As bars are not expected to extend beyond their co-rotation radius (\citealt{binney:2008}), we   
