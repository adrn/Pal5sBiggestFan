...
\changes{- smaller-scale variations, most prominent being an overdensity at (consistent w kupper2015) and underdensities at (consistent w erkal2017)
- our models should have these features, but unperturbed ones instead only reproduce epicyclic overdensities close to the cluster
}
...
\acknowledgements{
It is a pleasure to thank Charlie Conroy's and Doug Finkbeiner's groups at the CfA for helpful suggestions.
