...
- summary: analyzed pal5 tidal tails with deep photometric data
- unprecedented measurements of width, density, quantified wiggles for the first time
- qualitative model-comparison: bar perturbation matches some of the global features, but not all
- here discuss what each of the observed features may imply about additional sources of perturbation
...
- also see small-scale wiggles all along the trailing tail -- another signature of impacts?
