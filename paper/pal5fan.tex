...
\end{center}
\caption{\sa{Should we use the same axis limits as in Figure \ref{fig:cmds} for the top y-row (4 to $-4$ and all x-rows $-20$ to 15 deg)? Should we find a way to highlight/``blow up" the wiggles in the tracks? Maybe make the sim. points 10xlager in the top row. }
}
\label{fig:sims}
\end{figure*}
